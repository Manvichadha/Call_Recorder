      ...
      <div className="bg-white rounded-[40px] shadow-sm lg:ml-[108px] min-h-[calc(100vh-40px)] overflow-hidden pb-24 lg:pb-8 relative">
        ...
        <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-xl border-b border-gray-50 px-6 lg:px-10 pt-16 pb-8">
          <div className="flex items-center justify-between">
            <h1 className="text-4xl lg:text-[56px] font-extrabold text-gray-900 tracking-tight">Dashboard</h1>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
                  <h3 className="text-sm font-semibold text-gray-500 mb-1">Total Recordings</h3>
                  <div className="flex items-baseline gap-2 mb-1">
                    <span className="text-3xl font-extrabold text-gray-900">{stats.total}</span>
                    <span className="text-xs font-semibold text-emerald-500 flex items-center gap-0.5">
                      <ArrowUpRight className="w-3 h-3" /> calls recorded
                    </span>
                  </div>
                  <Sparkline />
                ...
                {/* Transcriptions Card */}
                <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
                  <h3 className="text-sm font-semibold text-gray-500 mb-1">Transcriptions</h3>
                  <div className="flex items-baseline gap-2 mb-4">
                    <span className="text-3xl font-extrabold text-gray-900">{stats.transcribed}</span>
              ...
              {/* ── AI Card ── */}
              <div className="relative bg-gradient-to-br from-amber-400 via-amber-400 to-orange-400 rounded-2xl p-7 overflow-hidden shadow-sm">
                ...
                <div className="relative z-10 max-w-md">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-xs font-bold uppercase tracking-wider text-amber-900/70">New Feature</span>
                  </div>
                  <h3 className="text-2xl font-extrabold text-gray-900 mb-2">Optimize with AI Analysis</h3>
                  <p className="text-sm text-amber-900/70 mb-5 leading-relaxed">
                    With our AI modules you get intelligent summaries, sentiment scores, and action items from every call automatically.
                  </p>
                  <button onClick={() => navigate('/recordings')}
                    className="bg-gray-900 text-white font-semibold text-sm px-5 py-2.5 rounded-xl hover:bg-gray-800 transition-all hover:shadow-lg flex items-center gap-2">
